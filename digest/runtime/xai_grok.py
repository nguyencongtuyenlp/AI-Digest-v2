...
def _article_payload(article: dict[str, Any], *, article_id: str) -> dict[str, Any]:
    return {
        ...
        "factual_summary_vi": _compact_text(article.get("factual_summary_vi", ""), 180),
        "why_it_matters_vi": _compact_text(article.get("why_it_matters_vi", ""), 180),
        "optional_editorial_angle": _compact_text(article.get("optional_editorial_angle", ""), 160),
        "summary_vi": _compact_text(article.get("summary_vi", ""), 220),
        "editorial_angle": _compact_text(article.get("editorial_angle", ""), 180),
